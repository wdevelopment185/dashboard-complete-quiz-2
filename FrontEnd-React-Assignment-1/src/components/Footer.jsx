...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { name: 'AI Text Humanizer', href: '/services/humanizer' },
      { name: 'Prompt Optimizer', href: '/services/prompt-optimizer' },
      { name: 'Readability Analyzer', href: '/services/readability' },
      { name: 'Keyword Density Checker', href: '/services/keyword-checker' },
    ],
    company: [
          ...
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">
                Document<span className="text-primary-400">Optimizer</span>
              </span>
            </div>
